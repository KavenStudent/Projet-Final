  ...
  let contenu = ` <div id="contenuRecherche"></div>
    ...
    <div class="row d-flex customized-row">
      <div class="col-lg-4 customized-item">
        ...
        <h2>But</h2>
        <p>Nous rêvions d'un réseau social permettant de facilement visualiser le portfolio de nos membres.</p>
      ...
      <div class="col-lg-4 customized-item">
        ...
        <p>Notre équipe consiste de cinq étudiants en informatique au Collège Ahuntsic.</p>
        <p class="details"><a class="btn btn-primary" href="#">détails »</a></p>
      </div><!-- /.col-lg-4 -->
      ...
      <div class="col-lg-4 customized-item">
        <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"></rect><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg>
        <h2>Mission</h2>
        <p>Nous cherchons à centraliser le processus création et de visualisation d'un portfolio.<!--Ils seront capable de montrer à des employeurs les compétences qui ont développées tout au long de leur vie --></p>
        <p class="details"><a class="btn btn-primary" href="#">détails  »</a></p>
      </div><!-- /.col-lg-4 -->
    ...
    <div class="row featurette">
      <div class="col-md-7">
        ...
        <p class="lead">Notre site peut être navigué sur mobile! Le site est dynamique et accèssible. Vous pouvez le naviguer confortablement avec des appareils de n'importe quel format.</p>
      </div>
      <div class="col-md-5">
        <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"></rect><text x="50%" y="50%" fill="#aaa" dy=".3em">500x500</text></svg>
