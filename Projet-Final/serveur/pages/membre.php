<div class="container big-container">
    <div class="premiere-colonne">
        ...
        <div class="container informations-profil">
            <label class=""><strong>Nom:</strong> <span>Vim hoang Nguyen</span></label>
            
            <label><strong>Courriel:</strong> <span>vim123@hotmail.fr</span></label>
            
            <label><strong>Téléphone:</strong> <span>514 677 4205</span></label>
            
            <label><strong>Description:</strong><span ><div id='description-profil'></div></span></label>
            
            <label><strong>Statut :</strong> <span>Abonné</span></label>

            <label><strong>Date abonnement :</strong> <span>2/7/2022</span></label>
        <!-- Content here -->
        </div>
