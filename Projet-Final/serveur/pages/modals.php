            ...
            <div class="modal-body modalCustom">
                ...
                <form id="form-enregistrer-membre">
                    ...
                    <div class="col-md-8 itemInput">
                        ...
                        <textarea id="description" class="form-control modalInput" name="description" rows="4" cols="50" required></textarea>
                    </div>
                    <div class="col-md-8 itemInput">
            ...
            <div class="modal-body">
                ...
                <form class="form-connexion connexionContainer" id="form-connexion">
                    ...
                    <div class="myInput">
                        ...
                        <input type="email" class="form-control inputConnexion modalInput" id="email-Connexion" name="email" required>
                    </div>

                    <div class="myInput">
                        <label for="password" class="form-label">Mot de passe</label>
                        <div class="passwordDivConnexion">
                            <input type="password" class="form-control passwordCustomConnexion modalInput" id="passwordConnexion" name="password" required>
