    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse itemsMobileVersion" id="navbarNavAltMarkup">
            ...
            <div id='divAuthentification'>
                <button type="button" class="btn btn-light buttonNav" data-bs-toggle="modal"
                    data-bs-target="#modalConnexion">Connexion</button>
                <button type="button" class="btn btn-light buttonNav" data-bs-toggle="modal"
                    data-bs-target="#modalInscription">Inscription</button>
            </div>
